...
# Twitch
TWITCH_URL = 'https://twitch.tv/ohmydaev'     # Your twitch channel url
TWITCH_CLIENT_ID = ''   # Your twitch dev app client ID
TW_CH = 'ohmydaev' # Your twitch channel name


# Telegram & Bot
TOKEN = '5274185286:AAFeGjmEJzxr8z_8PfOzIodh_soNegWZKBw'  # Your telegram bot token (Generated by BotFather)
CHAT_ID = '@ohmydaev'   # Channel tag
